                    ...
                    <div class="col pb-3">
                        <article class="card card-article border-0 ">
                            ...
                            <div class="card-body">
                                ...
                                <h3>
                                    <a class="card-post-title" href="index.php?action=post&id=<?= $post->id ?>"><?= htmlspecialchars($post->title, ENT_QUOTES, 'UTF-8') ?></a>
                                </h3>
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="pb-2 mb-2">
                            <div class="blog-postlist-content">
                                <span class="blog-postlist-title-active">Développement d'applications web </span>
                            </div>
                        </li>
