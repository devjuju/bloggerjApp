...
<section class="container-fluid bg-light-subtle spacing-col-padding-top-50 spacing-col-padding-bottom-50">
    ...
    <nav class="container" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Développement d'applications web</li>
        </ol>
    </nav>
    <!-- 1.2 page title -->
    <div class="container">
        <h1 class="titre-page">Développement d'applications web</h1>
    </div>
</section>
...
<section class="container spacing-col-padding-top-50">
    <div class="row">
        <!-- 2.1 List of articles in web development -->
            ...
            <div class="card card-shadow">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="pb-2 mb-2"><a href="index.php?action=blog_posts_web" class="blog-postlist-content"><span class="blog-postlist-title">Développement de sites web</span></a></li>
                        <li class="pb-2 mb-2">
                            <div class="blog-postlist-content"><span class="blog-postlist-title-active">Développement d'applications web</span></div>
                        </li>
                    </ul>
                </div>
            </div>
