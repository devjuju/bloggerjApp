        ...
        <div class="container spacing-col-padding-bottom-50">
            ...
            <div class="d-flex flex-row bd-highlight mb-3 spacing-content-marging-top-40">
                <div class="meta-list-blog bd-highlight">
                    <i class="bi bi-flag-fill fs-base me-1"></i>
                    <span class="fs-sm">Publié le : <strong><?= DateFormatter::enFrancais($post->created_at); ?></strong></span>
                </div>
                <div class="meta-list-blog bd-highlight">
                    <i class="bi bi-clock-fill fs-base me-1"></i>
                    <span class="fs-sm">Mis à jour le :<strong><?= DateFormatter::enFrancais($post->updated_at); ?></strong></span>
                </div>
            </div>
        </div>
    </section>
            ...
            <form action="index.php?action=update_post&id=<?= (int)$post->id ?>" method="post" class="needs-validation" novalidate>
                <div class="row gy-4">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p class="running-text mb-4 pb-2">Veillez remplir le formulaire de création pour mettre à jour l'article suivant : <strong><?= htmlspecialchars($post->title, ENT_QUOTES, 'UTF-8') ?></strong>.</p>
                        <div class="row g-4">
