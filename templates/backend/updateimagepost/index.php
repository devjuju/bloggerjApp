...
$title = "Modifier l'image mise en avant d'un article"; ?>
<?php ob_start();
?>
    ...
    <section class="container-fluid bg-light-subtle px-xxl-5 px-lg-4 pt-4 pt-lg-5 pb-2 pb-lg-4">
        ...
        <nav class="container spacing-col-padding-top-50" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a class="breadcrumb-links" href="index.php?action=update_post&id=<?= (int)$post->id ?>">Modifier un article</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Modifier l'image mise en avant d'un article</li>
            </ol>
        </nav>
        <!-- 2.1.2 page title -->
